...
export const personalData = {
  ...
  tagline:
    "I build production Kubernetes platforms and .NET services. 8+ years, mostly South African banking. AWS · Terraform · ArgoCD · Helm. Microsoft Certified: Azure Developer Associate.",
