...
const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(
  ({ className, ...props }, ref) => {
    return (
      <textarea
        className={cn(
          // text-base below md: iOS Safari force-zooms the viewport on focus
          // for any field under 16px, and leaves the page horizontally
          // scrolled after blur. Mirrors the same pattern in input.tsx.
