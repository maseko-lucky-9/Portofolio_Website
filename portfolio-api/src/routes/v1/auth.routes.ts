  ...
  app.post(
    ...
    async (request, reply) => {
      const result = await authService.register(
        request.body as { email: string; password: string; firstName?: string; lastName?: string }
      );
  ...
  app.patch(
    ...
    async (request, reply) => {
      ...
      const updated = await authService.updateProfile(
        user.id,
        request.body as { firstName?: string; lastName?: string; avatar?: string; bio?: string }
      );
